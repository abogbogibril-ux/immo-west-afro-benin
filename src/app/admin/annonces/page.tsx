  ...
  const ActionButtons = ({ b }: { b: any }) => (
    <div className="flex items-center gap-1 flex-shrink-0 flex-wrap">
      ...
      <Link href={`/bien/${b.id}`} target="_blank" title="Voir l'annonce"
        className="relative group inline-flex items-center justify-center p-2 rounded-lg text-blue-400 bg-blue-400/10 hover:bg-blue-400/20 transition-colors duration-150">
