            ...
            <div key={b.id} className="bg-[#1e293b] rounded-xl border border-[#334155] shadow-sm p-3 md:p-4 flex items-center gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                ...
                <Link href={`/bien/${b.id}`} target="_blank"
                  ...
                  className="relative group p-2 rounded-lg text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-colors">
                  <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">Voir</span>
