    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-5">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 text-center">
          ...
          <h3 className="font-bold text-blue-900 mb-1">Mise en relation confidentielle</h3>
          <p className="text-blue-700 text-sm mb-4">
            Les coordonnees du demandeur sont gerees par notre equipe. Contactez-nous pour etre mis en relation.
          </p>
          <a href="https://wa.me/22901961377 20?text=Bonjour, je suis interesse par le besoin ref : "
