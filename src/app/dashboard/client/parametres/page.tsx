        ...
        <div className="space-y-5">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="flex items-center justify-between mb-5">
              <h2 className="font-semibold text-gray-900">Mes alertes de recherche</h2>
              ...
              <div className="mb-5 p-4 bg-green-50 border border-green-100 rounded-xl space-y-3">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setShowAlerteForm(false)}
                    className="flex-1 py-2 border border-gray-200 text-gray-500 text-sm rounded-lg hover:bg-gray-50">
                    Annuler
                  </button>
                  <button onClick={addAlerte}
                    className="flex-1 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700">
                    Créer l'alerte
                  </button>
                </div>
              </div>
