...
function getStatutColor(statut: string) {
  switch (statut) {
    ...
    case 'Répondue': return 'bg-green-100 text-green-700'
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          { label: 'Répondues', value: stats.repondues, color: 'text-green-600', bg: 'bg-green-50' },
        ].map(s => (
                ...
                <div className="p-5">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex justify-between mt-1">
                      {STATUT_STEPS.map((s, i) => (
                        <span key={s} className={`text-[10px] ${i < step ? 'text-green-600 font-medium' : 'text-gray-400'} ${i === 0 ? '' : i === STATUT_STEPS.length - 1 ? 'text-right' : 'text-center'}`}
