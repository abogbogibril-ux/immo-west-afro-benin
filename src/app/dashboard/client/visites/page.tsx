  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-5">
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
            ...
            <div className="flex gap-2">
              <button onClick={() => setRatingModal(null)}
                className="flex-1 py-2.5 border border-gray-200 text-gray-500 text-sm font-medium rounded-xl hover:bg-[#0f172a]">
                Annuler
              </button>
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: 'Total', value: visites.length, color: 'text-white', bg: 'bg-[#1e293b]' },
              ...
              <div key={visite.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                  <div className="bg-gray-50 rounded-xl p-3">
                    ...
                    <p className="text-sm text-slate-400">à {visite.heure}</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-3">
