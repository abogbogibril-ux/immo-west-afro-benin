            ...
            {whatsappNum && (
              <div className="flex items-center gap-3">
                ...
                <a href={`https://wa.me/${whatsappNum.replace(/[\s+\-()]/g, '')}?text=${waText}`}
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#3b82f6] text-white text-sm font-semibold rounded-full hover:bg-[#2563eb] transition-colors min-h-[36px]">
